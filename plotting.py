...
def plotNodes(t=100, consistency=False):
    ...
    for n in range(nodes):
        ...
        plt.legend(('Diffusion', 'Minimization'), loc='best')
...
def plotNodesSingle(t=100, consistency=False):
    ...
    for n in range(nodes):
        ...
        plt.ylabel('MW')
        plt.ylim(ymin=0)
        plt.legend(('Diffusion', 'Minimization'), loc='best', fontsize=10)
...
def plotLinks(t=100):
    ...
    for l in range(len(LinkExport)):
        ...
        ax1.legend((b, c), ('Diffusion', 'Minimization'), bbox_to_anchor=(0, 1.15), ncol=2, loc=2, borderaxespad=0., fontsize=11)
